<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="invsearch.aspx.cs" Inherits="AdminItims.invsearch" %>
                        ...
                        <ContentTemplate>                        
                         <!-- Topbar -->
                            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                                ...
                                <%--    <div id="serachbox" runat="server" class="input-group">
                                        <asp:TextBox ID="txtSearch" runat="server" class="form-control bg-light border-0 small" placeholder="Axtar..."
                                            aria-label="Search" aria-describedby="basic-addon2"></asp:TextBox>
                                        <div class="input-group-append">
                                            <asp:LinkButton ID="btn_search" class="btn btn-primary" OnClick="btn_search_Click" runat="server"> <i class="fas fa-search fa-sm"></i></asp:LinkButton>
                                        </div>
                                    </div>--%>
                                </form>
                                <!-- Topbar Navbar -->
                        ...
                        <!-- InvAxtar -->
                                <div id="inv" runat="server">
                                    <table>
                                        <tr>
                                            <th>
                                                  <div id="serachbox" runat="server" style="margin-bottom: 3px;  width: 432px;" class="input-group">
                                                    <asp:TextBox ID="txtSearch" runat="server" class="form-control bg-light border-1 small" placeholder="Axtar..."
                                                        aria-label="Search" aria-describedby="basic-addon2"></asp:TextBox>
                                                    <div class="input-group-append">
                                                        <asp:LinkButton ID="btn_search" class="btn btn-primary" OnClick="btn_search_Click" runat="server"> <i class="fas fa-search fa-sm"></i></asp:LinkButton>
                                                    </div>
                                                </div>
                                                <asp:DropDownList ID="drpIp" runat="server" CssClass="drp" AutoPostBack="True" OnSelectedIndexChanged="drpIp_SelectedIndexChanged"></asp:DropDownList>
                                                <asp:DropDownList ID="drp2" runat="server" CssClass="drp" AutoPostBack="True" OnSelectedIndexChanged="drp2_SelectedIndexChanged"></asp:DropDownList>
                                            </th>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div>
                                                    ...
                                                    <asp:GridView ID="grdgLastRows" Style="color: black;" runat="server" AllowPaging="True" OnPageIndexChanging="grdgLastRows_PageIndexChanging">
                                                        <HeaderStyle
                                                            BackColor="#e2e4e4"
                                                            Font-Italic="false"
                                                            Font-Size="Larger" />
                                                    ...
                                                    <asp:GridView ID="grdResult" Style="color: black;" runat="server" AllowPaging="True" OnPageIndexChanging="grdResult_PageIndexChanging">
                                                        <HeaderStyle
                                                            BackColor="#e2e4e4"
                                                            Font-Italic="false"
                                                            Font-Size="Larger" />
                                                    ...
                                                    <asp:GridView ID="grdAll" runat="server" Style="color: black;" AllowPaging="True" OnPageIndexChanging="grdAll_PageIndexChanging">
                                                        <HeaderStyle
                                                            BackColor="#e2e4e4"
                                                            Font-Italic="false"
                                                            Font-Size="Larger" />
                                                    ...
                                                    <asp:Label ID="lblumusay" Style="font-size: 20px; font-family: auto; color: #355555;" runat="server" Text="Label"></asp:Label>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
