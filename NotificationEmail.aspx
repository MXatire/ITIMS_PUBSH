<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NotificationEmail.aspx.cs" Inherits="AdminItims.NotificationEmail" %>
                    ...
                    <div runat="server" class="container-fluid">
                        ...
                        <div id="riskGoster" runat="server">
                            <table>
                                <tr>
                                    <td>
                                        <asp:Label ID="Label1" runat="server" Text="Göndərən Email Ünvan"> </asp:Label>
                                        <br />
                                        <asp:TextBox ID="txtFrom" CssClass="textbox" runat="server"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:Label ID="Label4" runat="server" Text="Port"></asp:Label><br />
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <br />
                                        <asp:TextBox ID="txtHostmail" CssClass="textbox" runat="server"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:Label ID="Label5" runat="server" Text="Parol"></asp:Label>
                                        <br />
                                        <asp:TextBox ID="txtFromMailPass"  CssClass="textbox" runat="server"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:Label ID="Label2" runat="server" Text="Qəbul edən Email Ünvanlar"></asp:Label>
                                        <br />
                                        <asp:TextBox ID="txtTo" CssClass="textbox" runat="server"></asp:TextBox>
                                    </td>
                                    <td>
                                        <br />
                                        <asp:TextBox ID="txtTo1" CssClass="textbox" runat="server"></asp:TextBox>
                                    </td>

                                </tr>
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txtTo2" CssClass="textbox" runat="server"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtTo3" CssClass="textbox" runat="server"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txtTo4" CssClass="textbox" runat="server"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:Button ID="btnSave" Style="border-color: aliceblue; width: 120px; height: 40px; color: #55595d; cursor: pointer; background-color: #e5e5e5; font-size: 17px; margin-top: 5px;" runat="server" OnClick="btnSave_Click" Text="Yadda saxla" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
