<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="insreg.aspx.cs" Inherits="AdminItims.insreg" %>
                        ...
                        <div id="riskGoster" runat="server">
                            ...
                            <div id="addnew" runat="server">
                                <table>
                                    <tr>                                      
                                        <td>
                                            <asp:TextBox ID="TextBox2" Style="width: 130%; margin-right: 55px;" placeholder="İnsidentin baş verdiyi struktur" runat="server"></asp:TextBox></td>
                                        <td>
                                            <asp:TextBox ID="TextBox3" Style="width: 130%; margin-right: 55px;" placeholder="İnsidenti aşkar edən" runat="server"></asp:TextBox></td>
                                        <td>
                                            <asp:TextBox ID="TextBox4" Style="width: 130%; margin-right: 55px;" placeholder="İnsident haqqında məlumat" runat="server"></asp:TextBox></td>
                                        <td>
                                            <asp:TextBox ID="TextBox7" Style="width: 130%; margin-right: 55px;" placeholder="İnsidentin müddəti/başlama-bitmə tarixi" runat="server"></asp:TextBox></td>

                                    </tr>
                                    <tr>                                        
                                        <td>
                                            <asp:TextBox ID="TextBox8" Style="width: 130%; margin-right: 55px;" placeholder="İnsidentin yaranma səbəbi" runat="server"></asp:TextBox></td>
                                        <td>
                                            <asp:TextBox ID="TextBox9" Style="width: 130%; margin-right: 55px;" placeholder="İnsidentin təsir dərəcəsi/dəymiş zərər" runat="server"></asp:TextBox></td>
                                        <td>
                                            <asp:TextBox ID="TextBox16" Style="width: 130%; margin-right: 55px;" placeholder="İnsidentin həlli" runat="server"></asp:TextBox></td>
                                          <td>
                            ...
                            <div id="updatediv" runat="server">
                                <table>
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtUpdSiraSay" Enabled="false" Style="width: 130%; margin-right: 55px;" placeholder="ID" runat="server"></asp:TextBox></td>
                                        <td>
                                            <asp:TextBox ID="txthappenStruktur" Style="width: 130%; margin-right: 55px;" placeholder="İnsidentin baş verdiyi struktur" runat="server"></asp:TextBox></td>
                                        <td>
                                            <asp:TextBox ID="txtDiscoverStruktur" Style="width: 130%; margin-right: 55px;" placeholder="İnsidenti aşkar edən" runat="server"></asp:TextBox></td>
                                        <td>
                                            <asp:TextBox ID="txtInfo" Style="width: 130%; margin-right: 55px;" placeholder="İnsident haqqında məlumat" runat="server"></asp:TextBox></td>

                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtReason" Style="width: 130%; margin-right: 55px;" placeholder="İnsidentin yaranma səbəbi" runat="server"></asp:TextBox></td>
                                        <td>
                                            <asp:TextBox ID="txtTime" Style="width: 130%; margin-right: 55px;" placeholder="İnsidentin müddəti/başlama-bitmə tarixi" runat="server"></asp:TextBox></td>
                                        <td>
                                            <asp:TextBox ID="txtTesir" Style="width: 130%; margin-right: 55px;" placeholder="İnsidentin təsir dərəcəsi/dəymiş zərər" runat="server"></asp:TextBox></td>
                                        <td>
                                            <asp:TextBox ID="txtTedbir" Style="width: 130%; margin-right: 55px;" placeholder="İnsidentin həlli" runat="server"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td>
                            ...
                            <asp:ImageButton ID="imgBtnAdd" ImageUrl="~/img/plus.png" OnClick="imgBtnAdd_Click" runat="server" ToolTip="Əlavə et" Style="width: 20px; position: absolute; margin-top: 27px; margin-left: 4px;" />
                              <asp:GridView ID="grdgIns" Style="color: black; width: auto;" runat="server">
                                            <HeaderStyle
                                                BackColor="#e2e4e4"
                                                Font-Italic="false" />
                                            <Columns>
