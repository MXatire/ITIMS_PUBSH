<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="riskshow.aspx.cs" Inherits="AdminItims.riskshow" %>
                   ...
                   <!-- Page Heading -->
                    ...
                    <div runat="server" class="container-fluid">
                        ...
                        <div id="riskGoster" runat="server">
                                ...
                                <table>
                                    <tr>
                                        <td>
                                         ...
                                         <td>
                                             <asp:TextBox ID="TextBox2" placeholder="Riskin İfadəsi" runat="server"></asp:TextBox></td>
                                        <td>
                                            <asp:TextBox ID="TextBox3" placeholder="Riskin Zonası" runat="server"></asp:TextBox></td>
                                         <td>
                                             <asp:TextBox ID="TextBox4" placeholder="Ehtimal" runat="server"></asp:TextBox></td>
                                         <td>
                                             <asp:TextBox ID="TextBox5" placeholder="Təsir" runat="server"></asp:TextBox></td>
                                    </tr>
                                     <tr>
                                         <td>
                                            <asp:TextBox ID="TextBox6" placeholder="Mali Təsir" runat="server"></asp:TextBox></td>
                                         <td>
                                             <asp:TextBox ID="TextBox7" placeholder="Qeyri-Mali Təsir" runat="server"></asp:TextBox></td>
                                        <td>
                                            <asp:TextBox ID="TextBox8" placeholder="Təsirin azaldılması yolları" runat="server"></asp:TextBox></td>
                                         <td>
                                             <asp:TextBox ID="TextBox9" placeholder="Azalmadan sonra Ehtimal" runat="server"></asp:TextBox></td>
                                         <td>
                            ...
                            <asp:ImageButton ID="imgBtnAdd" ImageUrl="~/img/plus.png" OnClick="imgBtnAdd_Click" runat="server" ToolTip="Əlavə et"  style="width: 20px; position: absolute;  margin-top: 22px;  margin-left: 4px;" />
